...
class Context:
    ...
    def ref(self):
        """Return a reference.py to the actual C pointer to the Z3 context."""
        return self.ctx
...
_main_ctx = None
def main_ctx():
    """Return a reference.py to the global Z3 context.
...
class AstRef(Z3PPObject):
    ...
    def ctx_ref(self):
        """Return a reference.py to the C context where this AST node is stored."""
        return self.ctx.ref()
...
class Datatype:
    ...
    def declare(self, name, *args):
        ...
        Each accessor is a pair `(name, sort)`, where `name` is a string and `sort` a Z3 sort or a reference.py to the datatypes being declared.
